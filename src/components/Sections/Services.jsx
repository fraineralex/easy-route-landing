...
// Assets
import AddImage1 from "../../assets/img/innovation.jpg";
    ...
    <Wrapper id="services">
      <div className="whiteBg" style={{ padding: "60px 0" }}>
        <div className="container">
          <HeaderInfo>
            <h1 className="font40 extraBold">Nuestros increíbles servicios</h1>
            <p className="font13">
          ...
          <ServiceBoxRow className="flex">
            ...
            <ServiceBoxWrapper>
              <ServiceBox
                ...
                subtitle="Facilitamos la migración segura de datos existentes hacia la nube con respaldo garantizado."
              />
            </ServiceBoxWrapper>
            <ServiceBoxWrapper>
              <ServiceBox 
              ...
              subtitle="Adaptamos la interfaz de usuario de nuestro software a la identidad visual de cada cliente." />
            </ServiceBoxWrapper>
            <ServiceBoxWrapper>
              <ServiceBox
                icon="browser"
            ...
            <Advertising className="flexSpaceCenter">
              <AddLeft>
                ...
                <p className="font12">
                  ...
                  una seguridad robusta y una experiencia de usuario excepcional. Con un enfoque 
                  centrado en la modernidad, nuestro software se adapta a las necesidades cambiantes
                   del mercado, ofreciendo soluciones avanzadas que impulsan la eficiencia y el 
